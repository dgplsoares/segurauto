    ...
    try:
        async with engine.begin() as conn:
            await conn.execute(text(
                "TRUNCATE business.leads, business.outbox, business.quotes, business.integration_events, "
                "business.chat_messages, business.chat_sessions, business.identities, business.auth_sessions, "
                "business.otp_codes"
            ))
